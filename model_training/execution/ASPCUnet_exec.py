from NN_models.ASPCUnet17 import Custom_ASPCUNet17
...
if __name__ == '__main__':
    ...
    #
    update_csv_with_auc_scores(f'{save_path}/best_{network_name}{net_suffix}_kfold.csv', # Every iter
                               f'{save_path}/best_{network_name}{net_suffix}_kfold_AUC.csv', # Every iter for auc and roc score
                               trainer1,
