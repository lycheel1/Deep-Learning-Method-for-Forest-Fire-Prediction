...
if __name__ == '__main__':
    ...
    save_path = f'../../model_training/model_performance_{ds_name}/{network_name}_multiclass'
    ...
    train_set_ds = WildfireDataset(f'{dataset_folder}/X_2D_{train_set_suffix}.npy',
                                   ...
                                   f'{dataset_folder}/multiclass/Y_std_multiclass_train.npy')


    test_set_ds = WildfireDataset(f'{dataset_folder}/X_2D_std_test.npy',
                                  f'{dataset_folder}/X_1D_std_test.npy',
                                  f'{dataset_folder}/multiclass/Y_std_multiclass_test.npy')
