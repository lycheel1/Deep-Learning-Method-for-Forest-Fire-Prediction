...
from loss_functions.ConvMSELoss import ConvolutionalMSELoss
...
def criterion_make():
    return ConvolutionalMSELoss(kernel_size=7, attenuation=2, scaling_factor=1)
