...
def split(X_2D_path, X_1D_path, Y_path, save_folder):
...
if __name__ == '__main__':
    ...
    train_idx, test_idx = split(f'{ds_path}/{ds_name}_2D.npy', f'{ds_path}/{ds_name}_1D.npy', f'{ds_path}/{ds_name}_Y.npy', ds_path)
